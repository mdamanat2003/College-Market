  ...
  return (
    <div className="bg-gray-50 min-h-screen py-16 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        {/* The Startup Pitch: Problem vs Solution */}
        <div className="mb-24">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-white p-10 rounded-[2rem] shadow-sm border border-gray-200 hover:shadow-md transition">
              ...
              <ul className="space-y-3 text-gray-600">
                <li className="flex items-start gap-2">
                  <span className="text-red-400">❌</span> Messages get lost in the chat clutter.
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-red-400">❌</span> No guarantee of the buyer/seller's authenticity.
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-red-400">❌</span> High risk of last-minute ghosting or payment scams.
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white p-10 rounded-[2rem] shadow-sm border border-blue-100 hover:shadow-md transition relative overflow-hidden">
              ...
              <p className="text-gray-600 leading-relaxed mb-4 relative z-10">
                We built a dedicated, premium marketplace exclusively for verified university students. A single platform that handles everything from discovery to deal-closure.
              </p>
              <ul className="space-y-3 text-gray-600 relative z-10">
                <li className="flex items-start gap-2">
                  <span className="text-blue-500">✅</span> <strong>Escrow Payments:</strong> Money is held safely until item delivery.
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-blue-500">✅</span> <strong>Smart Search:</strong> Categorized listings (no endless scrolling).
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-blue-500">✅</span> <strong>Verified Trust:</strong> Only real students with college IDs.
                </li>
              </ul>
            </div>
          </div>

...
export default function MarketplaceHome() {
  ...
  // Responsive Grid Columns (Web = 3/4, Mobile = 1/2)
    ...
    <View style={styles.container}>
      ...
      <View style={styles.mainContent}>
        ...
        {isLoading ? (
          ...
          <FlatList
            key={numColumns} // Force re-render on orientation/width change
            data={products}
            ...
            renderItem={({ item }) => (
              <View style={[styles.cardWrapper, { width: `${100 / numColumns}%` }]}>
                {/* Yahan se onPress hata diya gaya hai */}
...
const styles = StyleSheet.create({
  ...
  mainContent: {
    flex: 1,
    maxWidth: 1400, // Center content on ultra-wide screens
    width: '100%',
    alignSelf: 'center',
  },
  categoryContainer: {
